...
Свой выбор IDE остановил на PyCharm Community Edition, т.к. на работе уже использую Visual Studio Code.

Для более удобного открытия подсветки синтаксиса склонировал ваш репозиторий на свой компьютер:
